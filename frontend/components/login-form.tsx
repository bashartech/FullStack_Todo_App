...
//   return (
//     <div className={cn("flex flex-col bg-white text-black gap-6", className)} {...props}>
//       <Card>
...
//                   <Button variant="outline" className="w-full cursor-pointer bg-white" onClick={signInWithGoogle} type="button">
...
//                     </div>
//                   </div>
//                   <Button type="submit" className="w-full bg-black cursor-pointer text-white" disabled={isLoading}>
